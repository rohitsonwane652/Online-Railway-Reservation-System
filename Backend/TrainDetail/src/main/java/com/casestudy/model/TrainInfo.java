...
public class TrainInfo {
	...
	public String toString() {
		return "TrainInfo [trainNo=" + trainNo + ", trainName=" + trainName + ", trainStart=" + trainStart
				+ ", trainEnd=" + trainEnd + ", trainDate=" + trainDate + ", totalSeats=" + totalSeats + ", capacityAC="
				+ capacityAC + ", capacitySL=" + capacitySL + ", seatsAC=" + seatsAC + ", seatsSL=" + seatsSL
				+ ", fareSL=" + fareSL + ", fareAC=" + fareAC + ", waitingSL=" + waitingSL + ", waitingAC=" + waitingAC
				+ ", stations=" + stations + "]";
	}
